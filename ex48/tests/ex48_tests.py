...
def test_directions():
    ...
    print(f'test_directions {result} passed.')
...
def test_verbs():
    ...
    print(f'test_verbs {result} passed.')
...
def test_stops():
    ...
    print(f'test_stops {result} passed.')
...
def test_nouns():
    ...
    print(f'test_nouns {result} passed.')
...
def test_numbers():
    ...
    print(f'test_numbers {result} passed.')
...
def test_errors():
    ...
    print(f'test_errors {result} passed.')
